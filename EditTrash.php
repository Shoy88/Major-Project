...
<?php 
  require("config.php");
  $trash = $_GET['samurai'];
  $query = "select * from trash where ID = ".$trash;
...
$sql = "UPDATE trash SET Street_Address = '$_POST[Street_Address]', District='$_POST[District]', Zip_code = '$_POST[Zip_code]', Comments = '$_POST[Comments]' where ID = '$trash' ";

if($conn->query($sql) == TRUE){
    echo "Update Done";
    header("Location:DashboardTrash.php");
}else{
  echo "Update Failed";
  header("Location:EditTrash.php?param=editfail");
}
