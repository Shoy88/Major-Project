...
<div class="imgrow ">
  <section class="imgcolumn content-area1">
    <p><a class="imgtxt" href="/PROJECT_FINAL/CreateTrash.php" > <img src="create.png" class="imgmenu"><h3> Create New</h3></a></p>   		
  </section> 
  <section class="imgcolumn content-area1">
  ...
  <section class="imgcolumn content-area1">
    <p><a class="imgtxt" href="/PROJECT_FINAL/ReportTrash.php" > <img src="reports.png" class="imgmenu"><h3>Reports </h3></a></p>
  </section> 
</div> 
